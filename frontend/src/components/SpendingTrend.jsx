...
export default function SpendingTrend({ refreshKey, statementId }) {
  const { data, loading, error } = useFetchOnMount(() => getAnalyticsByDate(statementId), [statementId, refreshKey]);

  return (
    <div className="card full-width-card">
      <div className="chart-title">Spending Trend</div>
      <div className="chart-subtitle">Successful spending per day</div>
